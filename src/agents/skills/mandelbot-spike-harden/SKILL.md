...
1. A runnable end-to-end implementation. If running in a git workflow, the spike child pushes its branch before marking `done` — the branch name is the handoff artifact the parent and any subsequent children use as their starting point.
