...
- **How we work**: a short "tech lead memo" for this batch. At minimum, point children at the governing plan. Add anything flow-specific — for example, whether children should open their own PRs or leave that to you, branching conventions, file-ownership boundaries, etc.
